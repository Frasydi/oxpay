...
const SignUp = () => {
  ...
  const handleGitHubSignUp = async () => {
    ...
    try {
      ...
      console.log('GitHub sign up successful:', response);
  ...
  const handleOXPaySignUp = async () => {
    setLoading(true);
    try {
      const response = await authService.loginWithOXPay();
      console.log('OXPay sign up successful:', response);
      alert('OXPay sign up successful!');
    } catch (error: any) {
      setError(error.message || 'OXPay sign up failed');
    } finally {
      setLoading(false);
    }
  };
